...
echo "       docker exec amnezia-wg-easy iptables -t nat -A PREROUTING -i wg0 -p tcp -d 10.8.0.1 --dport 443 \\"
echo "         -j DNAT --to-destination 172.17.0.1:${REALITY_PORT}   # -d 10.8.0.1 ОБЯЗАТЕЛЕН (иначе хайджек :443 всех клиентов)"
